    ...
    <PageSection eyebrow="Sobre o projeto" title="RadarTorres">
      <div className="grid gap-8 lg:grid-cols-[1fr_auto]">
        <div className="max-w-2xl text-muted">
          ...
          <p className="mt-4">
            Desenvolvido por <strong className="text-foreground">Gabriel Vasconselos</strong> e{' '}
            <strong className="text-foreground">Matheus Emanoel Souza</strong>.
          </p>
        </div>

        <div className="flex flex-col gap-3 rounded-xl border border-border bg-surface p-5">
          <h3 className="font-mono text-xs uppercase tracking-widest text-muted">Contato</h3>
          <a
